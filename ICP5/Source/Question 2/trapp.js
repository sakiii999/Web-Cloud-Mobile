...
app.controller('ttCtrl', function ($scope, $http) {
    ...
    // If Error
    $http.get("https://translate.yandex.net/api/v1.5/tr.json/getLangs?ui=en&key=trnsl.1.1.20180619T204223Z.da5d1bafdbfe3124.d972e801a22d1fe14d702c5a49f4ff8561696a87").error(function (data) {
