...
var url='mongodb://saki:Saki2106@ds121183.mlab.com:21183/icp6';//1.Modify this url with the credentials of your db name and password.
...
var updateRecord = function(db,old_data,new_data,callback) {
    //var oldValues=
    db.collection('books').updateOne(old_data,{$set:new_data},function(err, result) {
        if(err)
        {
